	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$('#jtableDiv').jtable({
				...
				actions: {
					listAction: 'control/payout.control.php?action=list',
					createAction: 'control/payout.control.php?action=create',
					updateAction: 'control/payout.control.php?action=update',
					deleteAction: 'control/payout.control.php?action=delete'
				},
				fields: {
					id: {
						key: true,
					...
					not_add_to_cash: {
						title: '<?php dic_show(""); ?>',
						type: 'checkbox',
                		values: { 1: '<?php dic_show("Not Less From Cash"); ?>', 0: '<?php dic_show("Not Less From Cash"); ?>' },
                		list: false
					}
				}
			});
